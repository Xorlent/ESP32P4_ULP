...
static constexpr int16_t LOW_LIMIT_C_DEG = 0;      // 0.00 C
static constexpr int16_t HIGH_LIMIT_C_DEG = 1000;  // 10.00 C
...
void setup()
{
    ...
    Serial.println("This example wakes when the measured SHT4X temperature is outside 0.00 C to 10.00 C.");
    Serial.println("Adjust LOW_LIMIT_C_DEG and HIGH_LIMIT_C_DEG for your application.");
